...
smoothScatter(train$kurd, train$EloDiff) # if kurd is large, EloDiff is close to 0
smoothScatter(train$kurd, train$meanElo) # if kurd is large, meanElo is less likely to be small
smoothScatter(train$skwd, train$EloDiff) # upward trend, as skwd ^, EloDiff ^
smoothScatter(train$skwd, train$meanElo)
smoothScatter(train$avgd, train$EloDiff, xlim=c(-1,1))
smoothScatter(train$avgd, train$meanElo, xlim=c(-1,1))		
smoothScatter(train$medd, train$EloDiff)
smoothScatter(train$medd, train$meanElo)
